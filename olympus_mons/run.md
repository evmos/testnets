...
This guide assumes that you have completed the tasks involved in [Evmos Incentivized Testnet](https://github.com/tharsis/testnets/blob/main/olympus_mons/gentx.md).  You should
