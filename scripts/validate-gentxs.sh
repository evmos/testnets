...
DAEMON=evmosd
DENOM=aphoton
GH_URL=https://github.com/tharsis/evmos # ex: https://github.com/cosmos/cosmos-sdk
BINARY_VERSION=v0.1.2 # ex :v0.44.0
GO_VERSION=1.17
PRELAUNCH_GENESIS_URL= # ex: https://raw.githubusercontent.com/cosmos/cosmos-sdk/master/$CHAIN_ID/genesis-prelaunch.json
GENTXS_DIR=$GOPATH/github.com/tharsis/testnets/arsia_mons/gentxs # ex: $GOPATH/github.com/cosmos/mainnet/$CHAIN_ID/gentxs"
